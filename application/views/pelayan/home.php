              ...
              <ul class="nav side-menu">
               ...
               <li><a><i class="fa fa-cutlery"></i> Product <span class="fa fa-chevron-down"></span></a>
                <ul class="nav child_menu">
                  <li><a href="<?php echo base_url('index.php/pelayan/pelayan/productMakanan'); ?>">Food</a></li>
                  <li><a href="<?php echo base_url('index.php/pelayan/pelayan/productMinuman'); ?>">Drink</a></li>                      
                </ul>
              </li>  
      ...
      <div class="nav_menu">
        <nav>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li>
              <a href="<?php echo base_url('index.php/pelayan/pelayan'); ?>" class="info-number">
